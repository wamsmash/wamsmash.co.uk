...
const TRACKS = [
  ...
  },
  {
    ...
    lane: "green",
    year: "2026",
    audio: "/assets/audio/UNDER-wamsmash.mp3",
    cover: "/assets/img/covers/under.jpg",
    note: "",
    blurb: "Weight carried steadily\nPressure absorbed\nMovement maintained",
    tags: "grounded rhythm\nsteady progression\ngreen lane movement\ncontained pressure",
  },
  {
    id: "unseen",
    title: "UNSEEN",
    lane: "blue",
    year: "2026",
    audio: "/assets/audio/UNSEEN-wamsmash.mp3",
    cover: "/assets/img/covers/unseen.jpg",
    note: "",
    blurb: "Existing without recognition\nQuiet persistence\nEnergy held inside",
    tags: "low light atmosphere\ninward focus\nblue lane restraint\ncontained energy",
  },
  {
    id: "yellow",
    title: "YELLOW",
    lane: "yellow",
    year: "2026",
    audio: "/assets/audio/YELLOW-wamsmash.mp3",
    cover: "/assets/img/covers/yellow.jpg",
    note: "",
    blurb: "The moment knows us\nParis, Milan, Durham\nEnjoy the ride",
    tags: "kinetic movement\nhigh contrast clarity\nyellow lane energy\nneon noir lift",
  },
  {
    id: "banshee",
    title: "BANSHEE",
    lane: "blue",
    year: "2026",
    audio: "/assets/audio/BANSHEE-wamsmash.mp3",
    cover: "/assets/img/covers/banshee.jpg",
    note: "",
    blurb: "Last train energy\nCold platforms waiting\nHeavy systems waking",
    tags: "late night uk bass\ncold platform pressure\nmodern dubstep motion\ntiming shifts and synth solos",
  },
  {
    id: "sailaway",
    title: "SAIL AWAY",
    lane: "blue",
    year: "2026",
    audio: "/assets/audio/SAILAWAY-wamsmash.mp3",
    cover: "/assets/img/covers/sailaway.jpg",
    note: "",
    blurb: "Cold stars over open water\nStrings flick through the midnight air\nBass and tide keep pulling forward",
    tags: "flamenco tension\ndubstep weight\nrolling bassline flow\nopen water energy",
  },
  {
    id: "jazz",
    title: "JAZZ",
    lane: "orange",
    year: "2026",
    audio: "/assets/audio/JAZZ-wamsmash.mp3",
    cover: "/assets/img/covers/jazz.jpg",
    note: "",
    blurb: "Slip inside\nJust melt away\nCalm under pressure",
    tags: "focus and forward motion\nwarm tones\nrestrained rhythm\ncontrolled energy",
  },
  {
    id: "nugget",
    title: "NUGGET",
    lane: "iridescent",
    year: "2026",
    audio: "/assets/audio/NUGGET-wamsmash.mp3",
    cover: "/assets/img/covers/nugget.jpg",
    note: "",
    blurb: "Instinct before thought\nCharacter over polish\nJoy without permission",
    tags: "playful deviation\nidentity led expression\nhumour and character\niridescent lane energy",
  },
  {
    id: "stripsets",
    title: "STRIP SETS",
    lane: "red",
    year: "2026",
    audio: "/assets/audio/STRIPSETS-wamsmash.mp3",
    cover: "/assets/img/covers/stripsets.jpg",
    note: "",
    blurb: "Bang by bang\nReps under load\nRhythm over hype",
...
if (isBundle01FullyOwned()) {
      ...
      if (!canAccessVault()) {
        console.log("bundle blocked by canAccessVault")
      ...
      try {
        console.log("starting bundle checkout")
